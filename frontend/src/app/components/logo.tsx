...
export default function Logo() {
  ...
  return (
    ...
    >
      ...
      <div className="h-[10px] w-[10px] rounded-xl bg-green transition-all group-hover:bg-gray-800 group-focus-visible:bg-gray-800 dark:group-hover:bg-white dark:group-focus-visible:bg-white"></div>
